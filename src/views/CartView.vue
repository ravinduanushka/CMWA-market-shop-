...
<template>
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div v-if="isEmpty" class="text-center py-20">
      ...
      <RouterLink
        to="/"
        class="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-primary text-white font-medium hover:bg-primary-dark transition-colors"
      >
    ...
    <div v-else>
      <div class="space-y-4 mb-8">
        <div
          ...
          :key="item.product.id"
          class="flex flex-col sm:flex-row gap-4 p-4 rounded-2xl bg-surface-card dark:bg-surface-card-dark border border-border dark:border-border-dark transition-all duration-200 hover:shadow-md"
        >
          <!-- Image -->
      ...
      <!-- Summary -->
      <div class="rounded-2xl bg-surface-card dark:bg-surface-card-dark border border-border dark:border-border-dark p-6">
